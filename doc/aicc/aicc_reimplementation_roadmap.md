...
| 子组 | Provider | 基础依赖 |
|---|---|---|
| WP-08A（行为与 builtin 配置完成，待 WP-15 接入） | OpenAI | OpenAI Responses |
| WP-08B（行为完成，配置化待整改） | Claude、MiniMax | Claude Messages |
| WP-08C（行为与 builtin 配置完成，待 WP-15 接入） | Gemini | Gemini Interactions |
