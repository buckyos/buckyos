...
| `provider.refresh_models` | Provider Instance、刷新策略 | discovery 更新、catalog resolver 生效、`models.list` 反映新 revision | Provider 不可达、返回损坏 inventory、刷新失败不破坏旧 inventory |
