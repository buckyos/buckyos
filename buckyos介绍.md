...
## BuckyOS是更好的Agent基础设施
- 每个Agent都有自己的did,可以通过http://$agentname.$zone_hostname 访问
- Agent通过did-document描述自己的能力
- 通过标准的http协议，Agent可以和Agent沟通，形成Agent Network
- 如果Agent的did-document里包含有wallet address,那么Agent就有付钱/收钱的能力。
