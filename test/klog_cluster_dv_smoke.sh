...
TEST_TARGET_DIR="${REPO_ROOT}/src/target/test_klog_cluster_dv"
...
wait_for_port "klog-service rpc" 127.0.0.1 4080
wait_for_port "klog-service raft" 127.0.0.1 21001
wait_for_port "klog-service inter" 127.0.0.1 21002
