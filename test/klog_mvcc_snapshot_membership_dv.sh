...
TEST_TARGET_DIR="${REPO_ROOT}/src/target/test_klog_mvcc_snapshot_membership_dv"

cd "${REPO_ROOT}"

export BUCKYOS_ROOT="${BUCKYOS_ROOT:-${REPO_ROOT}/.dev_buckyos}"
export KLOG_CLUSTER_DV_MODE="local-gateway-mvcc-snapshot-membership"
...
echo "[diag] KLOG_MVCC_SNAPSHOT_DV_KEYS=${KLOG_MVCC_SNAPSHOT_DV_KEYS:-<default>}"
