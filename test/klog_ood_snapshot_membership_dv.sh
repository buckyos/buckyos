...
TEST_TARGET_DIR="${REPO_ROOT}/src/target/test_klog_ood_snapshot_membership_dv"

cd "${REPO_ROOT}"

export BUCKYOS_ROOT="${BUCKYOS_ROOT:-${REPO_ROOT}/.dev_buckyos}"
export KLOG_CLUSTER_DV_MODE="local-gateway-ood-snapshot-membership"
...
echo "[diag] KLOG_OOD_SNAPSHOT_DV_ITEMS=${KLOG_OOD_SNAPSHOT_DV_ITEMS:-300}"
echo "[diag] KLOG_OOD_SNAPSHOT_DV_VALUE_BYTES=${KLOG_OOD_SNAPSHOT_DV_VALUE_BYTES:-512}"
