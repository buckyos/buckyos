import { BarChart3, Home, Plug, HardDrive, GitFork, FlaskConical } from 'lucide-react'
...
const tabs = [
  ...
  { key: 'playground' as const, icon: FlaskConical, labelKey: 'aiCenter.playground.title', label: 'Playground' },
