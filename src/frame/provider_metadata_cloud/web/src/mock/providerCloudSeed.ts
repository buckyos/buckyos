...
const originMappingRules: OriginMappingRuleRecord[] = [
  {
    mapping_key: 'openrouter-path-capture',
    provider_key: 'openrouter',
    mapping_mode: 'regex',
    match_pattern: '*/*',
  ...
  {
    mapping_key: 'openrouter-openai-template',
    provider_key: 'openrouter',
    mapping_mode: 'template',
    match_pattern: 'openai/*',
    origin_template: 'openai/<model>',
    regex: '',
    driver_transforms: ['alias'],
    model_transforms: ['trim'],
    priority: 10,
...
const originProviderAliases: OriginProviderAliasRecord[] = [
  {
    alias_key: 'openrouter-alias-anthropic',
    provider_key: 'openrouter',
    alias: 'anthropic',
    driver: 'anthropic',
    created_at: now,
  ...
  {
    alias_key: 'openrouter-alias-google-gemini',
    provider_key: 'openrouter',
    alias: 'google-gemini',
    driver: 'google',
    created_at: now,
  ...
  {
    alias_key: 'openrouter-alias-google',
    provider_key: 'openrouter',
    alias: 'google',
    driver: 'google',
    created_at: now,
  ...
  {
    alias_key: 'openrouter-alias-x-ai',
    provider_key: 'openrouter',
    alias: 'x-ai',
    driver: 'xai',
    created_at: now,
  ...
  {
    alias_key: 'openrouter-alias-moonshotai',
    provider_key: 'openrouter',
    alias: 'moonshotai',
    driver: 'moonshot',
    created_at: now,
...
export const providerCloudSeed: ProviderCloudSeed = {
  ...
  origin_mapping_rules: originMappingRules,
