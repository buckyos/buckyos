...
use buckyos_api::{
    ...
    AiccFallbackRule, AiccHandler, AiccLogicalNodeOverlay, AiccRouteOverlay, AiccRouteTraceEvent,
    AiccSchedulerProfile, AiccServerHandler, ApiType, AudioEnhanceRequest, AudioEnhanceResponse,
    AudioMusicRequest, AudioMusicResponse, AudioSpeechRecognitionRequest,
...
fn builtin_logical_model_definitions() -> Vec<LogicalModelDefinition> {
...
fn builtin_logical_tree_overlay() -> AiccRouteOverlay {
    AiccRouteOverlay {
