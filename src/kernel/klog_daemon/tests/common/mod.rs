...
"#,
        ...
        rpc_port = rpc_port,
        advertise_addr = options.advertise_addr.as_str(),
        advertise_port = advertise_port,
        advertise_inter_port = advertise_inter_port,
        advertise_admin_port = advertise_admin_port,
        rpc_advertise_port = rpc_advertise_port,
        ...
        cluster_gateway_addr = options.cluster_gateway_addr.as_str(),
...
pub async fn spawn_node_with_options(
    ...
    spawn_node_with_optional_raft_timing_and_options(
        node_id,
        port,
        cluster_name,
        auto_bootstrap,
...
async fn spawn_node_with_optional_raft_timing(
    ...
    let default_options = TestNodeSpawnOptions::default();
    spawn_node_with_optional_raft_timing_and_options(
        node_id,
        port,
        cluster_name,
...
async fn spawn_node_with_optional_raft_timing_and_options(
    node_id: u64,
    port: u16,
    cluster_name: &str,
    auto_bootstrap: bool,
    ...
    spawn_node_on_ports_with_optional_raft_timing_and_options(
        node_id,
        port,
        inter_node_port,
        admin_port,
...
async fn spawn_node_on_ports_with_optional_raft_timing_and_options(
    node_id: u64,
    port: u16,
    inter_node_port: u16,
    admin_port: u16,
...
pub async fn append_log_with_request_id(
    ...
    let body = AppendLogBody {
        ...
        timestamp,
        node_name: node_id.map(|id| format!("node-{}", id)),
...
pub async fn spawn_three_voter_cluster(
    ...
    let default_options = std::array::from_fn(|_| TestNodeSpawnOptions::default());
    spawn_three_voter_cluster_with_optional_raft_timing_and_options(
        cluster_name,
        port1,
        port2,
        port3,
...
async fn spawn_three_voter_cluster_with_optional_raft_timing_and_options(
    cluster_name: &str,
    port1: u16,
    port2: u16,
    port3: u16,
