...
Remove-Item -Recurse -Force -ErrorAction SilentlyContinue -Path (Join-Path $Root "bin\cyfs-gateway")
Remove-Item -Recurse -Force -ErrorAction SilentlyContinue -Path (Join-Path $Root "bin\test-server")
