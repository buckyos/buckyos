...
impl PanicReportRequest {
    pub fn new(product_name: &str, service_name: &str, panic_info: PanicInfo) -> Self {
        ...
        Self {
            ...
            exe_name,
            target: buckyos_kit::get_target().to_owned(),
            version: buckyos_kit::get_version().to_owned(),
            channel: buckyos_kit::get_channel().to_string(),
            info: panic_info,
        }
    }
